import { PUBLIC_INDEX, getProfile, listItems, requireStore } from "./api/stock/_lib.js";
...
export async function onRequestGet({ request, env }) {
  ...
  const items = (await listItems(store.kv, PUBLIC_INDEX)).filter((item) => item.status === "public");
